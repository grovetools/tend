...
func (s *Session) SaveRecording() error {
	...
	if err := os.WriteFile(htmlPath, []byte(htmlContent), 0o644); err != nil { //nolint:gosec // report output file
	...
	if err := os.WriteFile(jsonPath, jsonData, 0o644); err != nil { //nolint:gosec // report output file
...
func (s *Session) TakeScreenshot(filepath string) error {
	...
	if err := os.WriteFile(filepath, []byte(raw), 0o644); err != nil { //nolint:gosec // screenshot output file
