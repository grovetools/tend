...
-   **Interactive Mode (`-i`):** Pause execution before each step, allowing you to inspect the state of the system. For TUI tests, this mode enables an `(a)ttach` option to manually interact with the TUI in its tmux session.
